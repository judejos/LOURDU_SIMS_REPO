...
urlpatterns = [
    ...
    path('staffs-by-department/', StaffByDepartmentView.as_view(), name='staffs-by-department'),
    ...
    path('domains-by-department/', DomainsByDepartmentView.as_view(), name='domains-by-department'),
    path('entity-departments/', EntityDepartmentListCreateView.as_view(), name='entity-departments'),
    path('entity-departments/<int:pk>/', EntityDepartmentDetailView.as_view(), name='entity-department-detail'),
