...
function ProjectsPanel() {
  ...
  const [form, setForm]             = useState({ name: '', description: '', status: 'planning', team_lead: '', document: null });
  ...
  const handleCreate = () => {
    ...
    api.post('/Sims/projects/', formData)
      .then(() => { 
        setOpenDialog(false); 
        setForm({ name: '', description: '', status: 'planning', team_lead: '', document: null }); 
        load(); 
      })
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <Dialog open={openDialog} onClose={() => { setOpenDialog(false); setForm({ name: '', description: '', status: 'planning', team_lead: '', document: null }); }} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          <Button onClick={() => { setOpenDialog(false); setForm({ name: '', description: '', status: 'planning', team_lead: '', document: null }); }}>Cancel</Button>
