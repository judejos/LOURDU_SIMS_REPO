...
export const usersAPI = {
  ...
  staffByDept: () => api.get('/Sims/staffs-by-department/'),
...
export const orgAPI = {
  ...
  departments: () => api.get('/Sims/departments/'),
  createDepartment: (data) => api.post('/Sims/departments/', data),
  updateDepartment: (id, data) => api.patch(`/Sims/departments/${id}/`, data),
  deleteDepartment: (id) => api.delete(`/Sims/departments/${id}/`),
  ...
  domainsByDept: () => api.get('/Sims/domains-by-department/'),
  entityDepartments: () => api.get('/Sims/entity-departments/'),
  createEntityDept: (data) => api.post('/Sims/entity-departments/', data),
